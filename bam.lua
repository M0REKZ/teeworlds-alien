...
function build(settings)
	...
	if config.compiler.driver == "cl" then
		...
		elseif platform == "macosx" then
			settings.cc.flags:Add("-mmacosx-version-min=15.0")
			settings.link.flags:Add("-mmacosx-version-min=15.0")
			if config.minmacosxsdk.value then
				settings.cc.flags:Add("-isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX15.1.sdk")
				settings.link.flags:Add("-isysroot /Library/Developer/CommandLineTools/SDKs/MacOSX15.1.sdk")
			end
