...
{
	return round(CheckPos.x)/32 < -200 || teeround(CheckPos.x)/32 > GameServer()->Collision()->GetWidth()+200 ||
			round(CheckPos.y)/32 < -200 || teeround(CheckPos.y)/32 > GameServer()->Collision()->GetHeight()+200 ? true : false;
}
